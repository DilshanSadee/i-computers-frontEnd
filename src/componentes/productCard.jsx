...
export default function ProductCard(props) {
  ...
  return (
    <Link to={"/overview/" + product.productID } className="  w-[300px] h-[300px]  m-4 rounded-2xl shadow-2xl  p-4 flex flex-col  text-center cursor-pointer relative hover:[&_.buttons]:opacity-100 hover:[&_.primary-image]:opacity-0 overflow-x-hidden ">
      <div className=" w-[400px] h-[300px] lg:w-full lg:h-full  relative">
        ...
        <div className=" w-full h-[115px] bottom-0 bg-white flex  gap-4 justify-center items-center opacity-0 transition-opacity duration-300  absolute buttons overflow-x-hidden ">
          <button to={"/overview/" + product.productID} className="border-2 h-[50px] w-[150px] border-accent text-accent hover:bg-accent hover:text-black transition-colors duration-300 flex justify-center items-center ">
            Buy item
          </button>
