...
export default function ProductCard(props) {
  ...
  return (
    <div className="w-[400px] h-[300px]  m-4 rounded-2xl shadow-2xl overflow-hidden p-4 flex flex-col text-center cursor-pointer relative hover:[&_.buttons]:opacity-100 hover:[&_.primary-image]:opacity-0">
      ...
      <div className=" w-full h-[115px] bottom-0 bg-white flex  gap-4 justify-center items-center opacity-0 transition-opacity duration-300  absolute buttons ">
