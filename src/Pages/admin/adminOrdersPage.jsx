...
export default function AdminOrdersPage() {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-start p-6 bg-gradient-to-br from-gray-900 via-gray-800 to-black text-gray-100 overflow-auto" >
